...
const CreateProject = () => {
  ...
  if (loading) return <LoadingShow msg="Loading users..." />;
  if (error) return <LoadingShow msg="Error loading users" />;
    ...
    <div className="w-full max-w-6xl mx-auto p-8 bg-white rounded-lg shadow-xl space-y-6">
      ...
      <div className="flex justify-between items-center mb-6">
        <div className="flex items-center gap-4">
          ...
          <h2 className="text-3xl font-semibold text-blue-500">إنشاء <span className="text-black">مشروع جديد</span></h2>
        </div>
        <button onClick={() => location.href = "/Projects"} className="text-gray-600 hover:text-gray-900">
